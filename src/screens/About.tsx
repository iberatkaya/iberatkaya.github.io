...
export default function About() {
    ...
    const nodes: React.ReactNode[] = [
        <p>
            {"Hello. My name is Ibrahim Berat Kaya. I am from Pennsylvania, USA. I am " + _calculateAge(new Date(1998, 10, 26)).toString() + " years old. I currently reside in Istanbul. I study computer engineering at Istanbul Technical University and I am in my senior year."}
        </p>,
